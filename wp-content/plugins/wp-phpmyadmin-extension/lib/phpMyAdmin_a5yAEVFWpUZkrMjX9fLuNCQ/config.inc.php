...
$cfg['blowfish_secret']					= 'd\"g?t[{Gn;7d5x+`eg`FHnfm%lk`}9&V' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_a5yAEVFWpUZkrMjX9fLuNCQ/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://findmyphotographer.ca/wp-admin/?rand=98236872&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://findmyphotographer.ca/wp-admin/?rand=2316624&pma_logout=1';
