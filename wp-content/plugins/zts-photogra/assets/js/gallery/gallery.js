...
jQuery(document).ready(function($){
    ...
    var gallery_limit = zts_ajax_url.gallery_limit;
    ...
    $("#multiplefileupload").fileinput({
        ...
        dropZoneTitle: '<div class="upload-area"><i class="fas fa-images"></i><p>Browse or Drag and Drop .jpg, .png, .jpeg</p> <div> <button id="browse-btn">Browse File</button> </div></div>',
