...
function zts_add_profile_callback($atts)
{
  ...
  if(!empty($user_id)){
    ...
    <style>
       .main-profile-content .profile-main-lisiting {
        ...
        margin-top: 0;
         ...
         .profile-icon-list-items, .profile-categories-lists {
          list-style: none;
         ...
         .profile-icon-list-items .icon-list-item, .profile-categories-lists .cat-ist {
        justify-content: flex-start;
        text-align: left;
        display: flex;
        align-items: start;
    ...
    <div class="main-profile-content">
        <h1 class="profile-main-lisiting"><?php echo $company_name; ?> <span>photographer</span></h1>
        <ul class="profile-icon-list-items">
          <li class="icon-list-item">
              <span class="icon-list-icon">
                 <img src="https://findmyphotographer.ca/wp-content/uploads/2023/03/LOCATION.png" /> 
              </span>
          ...
          <li class="icon-list-item">
            <span class="icon-list-icon">
              <img src="https://findmyphotographer.ca/wp-content/uploads/2023/03/website.png" /> 
            </span>
            <span class="icon-list-text">VISIT <a href="<?php echo $company_url; ?>">WEBSITE</a></span>
          </li>
        </ul>

         <ul class="profile-categories-lists">
            <?php
