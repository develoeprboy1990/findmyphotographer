...
$l_category = isset($_GET['l_category']) ? $_GET['l_category'] : '';

$l_location = isset($_GET['l_location']) ? $_GET['l_location'] : '';

if ($l_category === 'Select category') {
...
if(!empty($l_location)){
  ...
  $get_location = get_term_by('name', $l_location, 'location');

  $l_location = $get_location->term_id;

}

if(!empty($l_category)){

  $get_category = get_term_by('name', $l_category, 'product_cat');

  $l_category = $get_category->term_id;
...
$category_id = intval($l_category);

$location = sanitize_text_field($l_location);



// SQL query to retrieve data from the custom table

if (empty($l_category) && empty($l_location)) {
    ...
    if($value['priority'] == '1'){
      ...
      <div class="text-center ">
        ...
        <div class="main-heading-section">
          ...
          <h2 class="premium-heading-title">Best Rated in 2022</h2>
    ...
    <div class="row detail">
        ...
        <div class="deatils-right-content">
          ...
          <div class="detail-box">
            ...
            <ul>
              ...
              <li><a target="blank" href="<?php echo get_site_url() . '/profile-page/?user_id=' .$value['user_id']; ?>" class="elementor-button-link" role="button">View Listing</a></li>
      ...
      <div class="text-center">
        ...
        <div class="main-heading-section green-color">
          ...
          <h2 class="premium-heading-title">Other in 2022</h2>
...
function zts_listing_title_page(){
  ...
  $l_location = isset($_GET['l_location']) ? $_GET['l_location'] : 'CANADA';

  ?>

  <div class="profile-title-location"><h1>WEDDING PHOTOGRAPHY IN <span><?php echo $l_location; ?></span></h1></div>
