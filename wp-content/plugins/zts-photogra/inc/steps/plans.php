        ...
        <div class="card">
                ...
                <div class="pricing-card bsic">
                    ...
                    <button
                      ...
                      data-business="<?php echo get_field('name_of_business') ?>"

                      data-address="<?php echo get_field('_website_address') ?>"

                      data-category="<?php echo get_field('category_listing') ?>"

                      data-location="<?php echo get_field('location') ?>"

                      data-page="<?php echo get_field('personal_page') ?>"

                      data-listing="<?php echo get_field('featured_listing') ?>"

                      data-gallery="<?php echo get_field('image_gallery') ?>"

                      data-price="<?php echo $product_price;  ?>"

                      data-scope="<?php echo get_field('scope')  ?>"

                      data-id="<?php echo get_the_ID(); ?>" class="cta-btn zts_plan_btn_click next-btn">order Now</button>
...
<div class="price-table__ribbon">
  ...
  if(get_field('scope') == 'basic'){
    ?>
          <div class="price-table__ribbon-inner">
          Popular       
        </div>
    <?php
